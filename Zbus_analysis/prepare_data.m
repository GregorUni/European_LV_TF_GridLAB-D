...
%% Non symetrically distributed load, voltage calculation

EdgeTable = table([s t],Lines{:,'R1'},Lines{:,'X1'},Lines{:,'Length'},'VariableNames',{'EndNodes' 'R1' 'X1' 'Length'});
G1 = digraph(EdgeTable);

%V1=Vo- L*(R01cos+X01sen)
